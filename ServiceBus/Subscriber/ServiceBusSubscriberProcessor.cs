...
namespace ServiceBusSubscriber
{
    public class ServiceBusSubscriberProcessor : IAsyncDisposable
    {
        ...
        public Func<ServiceBusProcessMessageEventArgs, Task>? ClientProcessMessageFunc { get; set; }
        public Func<ServiceBusProcessErrorEventArgs, Task>? ClientProcessErrorFunc { get; set; }
